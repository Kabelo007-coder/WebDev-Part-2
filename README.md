...
Proposal — the "Colour Scheme" section described light grey/white neutral backgrounds, and now it is a dark navy theme throughout. I rewrote that section to describe the real palette (navy backgrounds, amber for CTAs/hover, off-white text) and noted plainly that the design moved to this dark theme instead of light neutrals.
